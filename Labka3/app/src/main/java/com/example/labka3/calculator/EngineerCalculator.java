...
public class EngineerCalculator extends SampleCalculator{

    private static EngineerCalculator calc;

    public static EngineerCalculator getCalc(){
        if (calc == null){
